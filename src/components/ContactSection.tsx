...
const ContactSection = () => {
  ...
  return (
    <section id="contact" className="py-20 bg-gradient-to-b from-card/10 to-transparent">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Let's collaborate on your next project or discuss opportunities in tech and innovation
          </p>
        </div>
                ...
                {contactInfo.map((item) => {
                  ...
                  return (
                    <a
                      key={item.label}
                      href={item.href}
                      className="flex items-center gap-4 p-4 rounded-xl hover:bg-card-hover transition-smooth group"
                    >
                ...
                {socialLinks.map((social) => {
                  ...
                  return (
                    <Button
                      ...
                      className="w-12 h-12 rounded-xl hover:scale-110 transition-smooth group"
                    >
